...
combo_t key_combos[COMBO_COUNT] = {COMBO(enter_combo, KC_ENT), COMBO(home_combo, KC_HOME), COMBO(end_combo, KC_END)};
    ...
    if (is_keyboard_master()) {
        switch (get_highest_layer(layer_state)) {
            ...
            case (_SYM):
                ...
                break;
            case (_NAV):
                rgb_matrix_set_color(28, 255, 199, 52);
                rgb_matrix_set_color(29, 255, 199, 52);
                rgb_matrix_set_color(30, 255, 199, 52);
                rgb_matrix_set_color(31, 255, 199, 52);
                rgb_matrix_set_color(32, 255, 199, 52);
                rgb_matrix_set_color(33, 255, 199, 52);
                break;
            case (_FN):
                rgb_matrix_set_color(28, 3, 255, 138);
                rgb_matrix_set_color(29, 3, 255, 138);
                rgb_matrix_set_color(30, 3, 255, 138);
                rgb_matrix_set_color(31, 3, 255, 138);
                rgb_matrix_set_color(32, 3, 255, 138);
                rgb_matrix_set_color(33, 3, 255, 138);
                break;
            case (_MOUSE):
        ...
        switch (get_highest_layer(layer_state)) {
            ...
            case (_SYM):
                ...
                break;
            case (_NAV):
                rgb_matrix_set_color(62, 255, 199, 52);
                rgb_matrix_set_color(63, 255, 199, 52);
                rgb_matrix_set_color(64, 255, 199, 52);
                rgb_matrix_set_color(65, 255, 199, 52);
                rgb_matrix_set_color(66, 255, 199, 52);
                rgb_matrix_set_color(67, 255, 199, 52);
                break;
            case (_FN):
                rgb_matrix_set_color(62, 3, 255, 138);
                rgb_matrix_set_color(63, 3, 255, 138);
                rgb_matrix_set_color(64, 3, 255, 138);
                rgb_matrix_set_color(65, 3, 255, 138);
                rgb_matrix_set_color(66, 3, 255, 138);
                rgb_matrix_set_color(67, 3, 255, 138);
                break;
            case (_MOUSE):
